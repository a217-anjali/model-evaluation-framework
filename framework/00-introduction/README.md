...
2. Find a [use case](../01-use-cases/) that looks like yours
3. Assign your risk tier (R1–R4) using the [AI Risk Management Toolkit](risk-tiering.md)
4. Follow the [lifecycle](../02-lifecycle/) phase by phase — each phase tells you what to do, the risk tier tells you how deeply, and bridge files point you to the right testing module
5. At each governance gate, check the [evidence catalogue](../04-evidence-catalogue/) for your tier
6. Use [templates](../05-templates/) to produce required documents
